											...
											<table id="example" class="table table-striped table-bordered " >
												...
												@foreach($coin as $data)
													<tr>
														...
														@endif
														<td>
															<a href="{{ route('admin.view.awaiting.offer' , $data->id) }}"  class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i> &nbsp; View Pending Trade</a>
														</td>
													</tr>
												@endforeach
